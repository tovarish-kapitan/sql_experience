...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(279, 104)
        self.layoutWidget = QtWidgets.QWidget(Dialog)
        self.layoutWidget.setGeometry(QtCore.QRect(11, 10, 258, 83))
        ...
        self.pushButton.clicked.connect(Dialog.load_slot)
        self.lineEdit.textChanged['QString'].connect(Dialog.set_text_slot)
