...
class AirplaneSpec(Base):
    ...
    def __init__(self, airplane_type=1, radius=1000, distance=1000,
                 ...
                 min_height=500, service_ceiling=25000, max_take_off_weight=20000,
                 empty_weight=15000, fuel_capacity=5000, max_load=2000, engine_type=1,
                 engine_qty=1, engine_thrust=1000, max_normal_overload=0, max_transverse_overload=0,
                 path_to_cdo = 'no way', path_to_cdi = 'no way', path_to_cl = 'no way'):
